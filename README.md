...
- **[SRE Simulator](https://github.com/tuxerrante/SRESimulator)** - AI-guided incident response training for Azure Red Hat OpenShift.  
  [Live demo](https://play.sresimulator.osadev.cloud/game) _(temporary deployment, may be offline at any time)_.
- **[Proficiency](https://github.com/tuxerrante/proficiency)** - Go Profiling automation. Also as [GitHub Action](https://github.com/marketplace/actions/proficiency-go-api-performance)!
...
- 🏍️ Former(?) motorbiker and [low-quality vlogger](https://www.youtube.com/@pastafurious)
